...
namespace {
    ...
    {
        const ARCHIVE_FILENAME   = 'bantranhanhnghethuat_cd49ee1dbc9f93603312_20230409140117_archive.zip';
        const ARCHIVE_SIZE       = '686634763';
        const INSTALLER_DIR_NAME = 'dup-installer';
        const PACKAGE_HASH       = 'cd49ee1-09140117';
        const SECONDARY_PACKAGE_HASH = 'c25a013-09140117';
